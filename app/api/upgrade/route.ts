...
ВАЖНО: Ты работаешь только с тем, что написал студент. Не придумывай то, чего не было в его ответе — только расширяй, уточняй и исправляй его мысли.
...
===ОТВЕТ СТУДЕНТА (РАБОТАЙ ТОЛЬКО С ЭТИМ ТЕКСТОМ)===
...
5. upgradedSolution должен читаться как доработанная версия ответа студента, а не как новый ответ.

...
3. Добавляй конкретику туда, где студент был расплывчат — используй конкретные цифры, фреймворки, примеры из кейса.
...
8. ЗАПРЕЩЕНЫ общие фразы типа "важно анализировать данные", "нужно учитывать пользователей" — только конкретные действия на основе данного кейса.
9. НИКОГДА не используй мноточие "..." вместо текста — пиши полный ответ до конца.
